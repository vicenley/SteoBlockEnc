...
1 ancilla) is
\begin{equation}
	U = (V^\dagger \otimes I_a) \cdot U_{\mathrm{diag}}
	\cdot (V \otimes I_a),
...
\begin{proposition}[Heisenberg Gate Count]
	...
	independent of $J$, $h$, and $\|H\|$.
	% TODO: Enumerate exact gate count after decomposition
\end{proposition}
...
% TODO: Add 3-qubit Heisenberg or other larger example
